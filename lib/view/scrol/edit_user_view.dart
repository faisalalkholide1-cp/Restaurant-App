...
class _EditUserViewState extends State<EditUserView> {
  ...
  getRestu() async {
    ...
    setState(() {
      ...
      selectedRestaurantId = widget.user.restaurantId ?? "";
    });
  }
            ...
            onPressed: () async {
              if (userName.text.isEmpty ||
                ...
                if (response["status"] == "Success") {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text("قم بتعديل البيانات قبل الحفظ",
                          style: TextStyle(
                              fontSize: 15,
                              color: Colors.white,
                              fontWeight: FontWeight.bold)),
            ...
            Card(
              child: DropdownButton<String>(
                ...
                value: selectedRestaurantId == null
                    ? null
                    : restaurants.any((e) => e["id"] == selectedRestaurantId)
